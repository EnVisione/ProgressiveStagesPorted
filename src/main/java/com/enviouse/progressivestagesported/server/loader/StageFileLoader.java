package com.enviouse.progressivestagesported.server.loader;
...
import com.enviouse.progressivestagesported.common.tags.StageTagRegistry;
...
public class StageFileLoader {
    ...
    private FileValidationResult validateStageFile(Path file) {
        ...
        for (String itemId : stage.getLocks().getItems()) {
            try {
                var rl = net.minecraft.resources.Identifier.parse(itemId);
        ...
        for (String blockId : stage.getLocks().getBlocks()) {
            try {
                var rl = net.minecraft.resources.Identifier.parse(blockId);
