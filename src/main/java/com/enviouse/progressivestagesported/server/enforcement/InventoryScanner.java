...
public class InventoryScanner {
    ...
    public static int scanAndDropLockedItems(ServerPlayer player) {
        ...
        // Check all inventory slots (main inventory 0-35, armor 36-39, offhand 40)
            ...
            if (toDrop.size() == 1) {
                ...
                if (StageConfig.isShowLockMessage()) {
                    ...
                    player.sendSystemMessage(
                        com.enviouse.progressivestagesported.common.util.TextUtil.parseColorCodes(
    ...
    public static int scanAndMoveLockedItemsFromHotbar(ServerPlayer player) {
        ...
        // Hotbar slots are indices 0-8 in inventory
        for (int hotbarSlot = 0; hotbarSlot < 9; hotbarSlot++) {
            ...
            for (int invSlot = 9; invSlot < 36; invSlot++) {
                ItemStack existing = inventory.getItem(invSlot);
                if (existing.isEmpty()) {
